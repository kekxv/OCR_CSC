...
// #ifdef LogShow DEBUG
#define LogI(Tag,format,...) kekxv::Log::I(Tag,"[" __FILE__ ":%d ] " format, __LINE__,##__VA_ARGS__)
#define LogD(Tag,format,...) kekxv::Log::D(Tag,"[" __FILE__ ":%d ] " format, __LINE__,##__VA_ARGS__)
#define LogE(Tag,format,...) kekxv::Log::E(Tag,"[" __FILE__ ":%d ] " format, __LINE__,##__VA_ARGS__)
// #else
// #define LogI(Tag,format,...) kekxv::Log::I(Tag,format, ##__VA_ARGS__)
// #define LogD(Tag,format,...) kekxv::Log::D(Tag,format, ##__VA_ARGS__)
// #define LogE(Tag,format,...) kekxv::Log::E(Tag,format, ##__VA_ARGS__)
// #endif
